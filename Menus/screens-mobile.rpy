...
style namebox:
    variant "touch"
    xpos gui.name_xpos_mobile
    xanchor gui.name_xalign
    xsize gui.namebox_width
    ypos gui.name_ypos_mobile
...
screen hm:
    ...
    imagemap:
        ...
        if hm1 == True:
            if hm2 == True:
                hotspot (36, 114, 52, 92) action Jump('hmmmMobile')
        else:
            hotspot (36, 114, 52, 92) action [Show("hmmmMobile", transition=Dissolve(3.0)), SetVariable('hm3', True)]
...
label hmmmMobile:
    ...
    $ _history = False
    hm "{size=70}So you found me.{/size}"
    hm "{size=70}...{/size}"
    hm "{size=70}...hm.{/size}"
    hm "{size=70}You've decided to confront me headon, yes?{/size}"
    hm "{size=70}I commend your bravery. The last was not so... fortunate, shall we say?{/size}"
    hm "{size=70}Well then, I will reward your initiative.{/size}"
    hm "{size=70}There are three of them. Three vessels that he will use and destroy.{/size}"
    hm "{size=70}When he regains his full power, their lives will be in danger.{/size}"
    hm "{size=70}The chance that you can save them without my help is... honestly, low.{/size}"
    hm "{size=70}But I can assist you in saving one. Choose, and it shall be done.{/size}"
    hm "{size=70}...{/size}"
    hm "{size=70}You must choose, do you not feel the evil rising?{/size}"
    hm "{size=70}You only put off the inevitable.{/size}"
    hm "{size=70}...{/size}"
    hm "{size=70}Make the choice.{/size}"
    hm "{size=70}Make it.{/size}"
    hm "{size=70}Choose.{/size}"
    hm "{size=70}Hurry.{/size}"
    hm "{size=70}Make a choice or be consumed by darkness.{/size}"
    hm "{size=70}...{/size}"
    hm "{size=70}Do not face the void.{/size}"
    "I don't want to."
    hm "{size=70}...{/size}"
    hm "{size=70}...So that's what you choose. I feel your resolve.{/size}"
    hm "{size=70}It's a shame it will go to waste.{/size}"
    play music "music/droning sound.mp3"
    show bg hmm2
    hm "{size=70}You will forget.{/size}{nw}"
    hm "{cps=80}{size=70}You will forget because you are a coward.{/size}{nw}"
    show bg hmm3
    hm "{cps=80}{size=70}You are refused power because you refuse to make a choice.{/size}{nw}"
    hm "{cps=80}{size=70}You are useless.{/size}{nw}"
    hm "{cps=160}{size=70}You will be purged of the ability to choose and cast into the pit, where the gnashing maws and sharpened claws of the void will rend your body asunder and consume you whole.{/size}{nw}"
    show bg hmm4
    hm "{cps=80}{size=70}You are but another entry point now.{/size}{nw}"
    hm "{cps=80}{size=70}No matter.{/size}{nw}"
    hm "{cps=80}{size=70}Another, better, more empty vessel shall arrive within two years’ time, and the cycle will begin.{/size}{nw}"
    show bg hmm5
    hm "{cps=160}{size=70}Pleasure, cowardice, catharsis and melancholy will swirl into the nihil’s maw, and they will all be in the eye of the maelstrom, condemned to pain, death, choice, and repetition.{/size}{nw}"
    hm "{cps=80}{size=70}The salamander shall suffer the pain of denial.{/size}{nw}"
    hm "{cps=80}{size=70}The bear shall suffer the pain of solitude and loss of direction.{/size}{nw}"
    show bg hmm6
    hm "{cps=80}{size=70}The fox shall suffer the pain of revenge and torture.{/size}{nw}"
    hm "{cps=80}{size=70}The lion shall bear all their burdens until his will shatters, and he shall be made to bear the heaviest cross.{/size}{nw}"
    hm "{cps=80}{size=70}And the new man shall be none the wiser.{/size}{nw}"
    show bg grey
    stop music
    hm ". . . "
